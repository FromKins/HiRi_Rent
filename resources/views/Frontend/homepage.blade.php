                ...
                <div class="row justify-content-center no-gutters">
                    <div class="col-md-10 d-flex align-items-center">
                        <div class="services-wrap rounded-right w-100">
                            ...
                            <p class="text-center mt-5"><a target="_blank" href="https://wa.me/6282118277500" class="btn text-center mx-auto m-auto ml-auto btn-primary py-3 px-4">Reserve Your Perfect
                                    Car</a>
                            </p>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row justify-content-end">
            <div class="col-md-6 heading-section heading-section-white ftco-animate">
                ...
                <a target="_blank" href="https://wa.me/6282118277500" class="btn btn-primary btn-lg">Become A Driver</a>
            </div>
        </div>
    </div>
</section>
